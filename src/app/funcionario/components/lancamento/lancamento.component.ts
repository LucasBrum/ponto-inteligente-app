...
import * as moment from 'moment'; // Todas funcoes do moment estarão no objeto "moment"

declare var navigator: any; // Usa o recurso do navegador para obter a localizacao GPS do usuário
